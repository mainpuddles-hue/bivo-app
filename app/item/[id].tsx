...
function createStyles(BIVO: LegacyTokens) {
  return StyleSheet.create({
    ...
    priceBox: { flex: 1 },
    priceLabel: { fontSize: 11, fontFamily: BIVO.sans, color: BIVO.ink2, letterSpacing: 0.9, textTransform: 'uppercase' },
    ...
    freeLabel: { fontSize: 11, fontWeight: '700', fontFamily: BIVO.sansBold, color: BIVO.live, letterSpacing: 0.9, textTransform: 'uppercase' },
