...
function PostDetailScreenInner() {
  ...
  const handleShare = () => {
    if (!post) return
    shareContent({ title: post.title, text: post.title, url: `https://bivoapp.io/post/${post.id}` })
  }
...
const styles = StyleSheet.create({
  ...
  relatedHeartCircle: { position: 'absolute', top: 8, right: 8, width: 38, height: 38, borderRadius: 999, alignItems: 'center', justifyContent: 'center', zIndex: 1 },
  ...
  heroCircle: { width: 44, height: 44, borderRadius: 999, alignItems: 'center', justifyContent: 'center' },
