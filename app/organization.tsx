...
const styles = StyleSheet.create({
  ...
  adStatusText: { fontSize: 12, fontFamily: fonts.bodySemi },
  ...
  addImageText: { fontSize: 12, fontWeight: '600', fontFamily: fonts.bodySemi },
  imageHint: { fontSize: 12, marginTop: 2, fontFamily: fonts.body },
  textArea: {
