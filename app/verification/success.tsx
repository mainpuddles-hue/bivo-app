    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top + 20 }]}>
      <View style={styles.content}>
        ...
        <Animated.View style={[styles.unlockedCard, { backgroundColor: colors.card, borderColor: colors.border, opacity: fadeAnim }]}>
          ...
          <View style={styles.featureRow}>
            <View style={[styles.featureIcon, { backgroundColor: '#7C5CBF18' }]}>
              <ShieldCheck size={18} color="#7C5CBF" />
            </View>
            <View style={styles.featureText}>
...
const styles = StyleSheet.create({
  ...
  unlockedCard: { width: '100%', borderRadius: 14, borderWidth: StyleSheet.hairlineWidth, padding: 18, gap: 16, marginBottom: 32 },
  unlockedTitle: { fontSize: 16, fontWeight: '700', marginBottom: 4 },
